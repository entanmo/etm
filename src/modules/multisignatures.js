...
var scheme = require('../scheme/multisignatures');
...
shared.getAccounts = function (req, cb) {
  ...
  library.scheme.validate(query, /*{
    ...
    required: ['publicKey']
  }*/ scheme.getAccounts, function (err) {
    if (err) {
...
shared.addMultisignature = function (req, cb) {
  ...
  }*/ scheme.addMultisignature, function (err) {
    if (err) {
      return cb(err[0].message);
    }

...
var jsonSql = require('../utils/json-sql')()
...
var flagsHelper = require('../utils/uia/flags-helper.js')
var addressHelper = require('../utils/address.js')
var amountHelper = require('../utils/amount.js');
var scheme = require('../scheme/uia');
...
function UIA(cb, scope) {
  ...
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ISSUER, require('../utils/uia/issuer.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ASSET, require('../utils/uia/asset.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_FLAGS, require('../utils/uia/flags.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ACL, require('../utils/uia/acl.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_ISSUE, require('../utils/uia/issue.js'))
  library.base.transaction.attachAssetType(TransactionTypes.UIA_TRANSFER, require('../utils/uia/transfer.js'))
...
__private.queryTransactions = function (query, cb) {
  var func = 'list'
  var param = query
  var list = true
...
shared.getIssuers = function (req, cb) {
  ...
  }*/ scheme.getIssuers, function (err) {
...
shared.getIssuerAssets = function (req, cb) {
  ...
  }*/ scheme.getIssuerAssets, function (err) {
    if (err) return cb('Invalid parameters: ' + err[0])
...
shared.getAssetAcl = function (req, cb) {
  ...
  }*/ scheme.getAssetAcl, function (err) {
    if (err) return cb('Invalid parameters: ' + err[0])
...
shared.getBalances = function (req, cb) {
  ...
  }*/ scheme.getBalances, function (err) {
    if (err) return cb('Invalid parameters: ' + err[0])
...
shared.getMyTransactions = function (req, cb) {
  ...
  library.scheme.validate(query, /*{
  ...
  }*/ scheme.getMyTransactions, function (err) {
    if (err) return cb('Invalid parameters: ' + err[0])
    ...
    __private.queryTransactions(query, cb)
  })
}
...
shared.getTransactions = function (req, cb) {
  ...
  library.scheme.validate(query, /*{
    ...
    if (err) return cb('Invalid parameters: ' + err[0])
    __private.queryTransactions(query, function (err, data) {
...
shared.transferAsset = function (req, cb) {
  ...
  }*/ scheme.transferAsset, function (err) {
    if (err) {
